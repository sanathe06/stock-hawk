...
public class MyStocksActivity extends BaseActivity implements LoaderManager.LoaderCallbacks<Cursor> {
            ...
            new MaterialDialog.Builder(mContext).title(R.string.symbol_search)
                    ...
                    .input(R.string.input_hint, R.string.input_prefill, new MaterialDialog.InputCallback() {
                        ...
                        public void onInput(MaterialDialog dialog, CharSequence input) {
                            ...
                            if (c.getCount() != 0) {
                                Toast toast =
                                        Toast.makeText(MyStocksActivity.this, R.string.msg_stocke_already_saved,
                                                Toast.LENGTH_LONG);
    ...
    public void networkToast() {
        mSnackbar = Snackbar.make(findViewById(R.id.fab),
                R.string.msg_no_network, Snackbar.LENGTH_INDEFINITE);
        mSnackbar.setAction(R.string.snack_action, new View.OnClickListener() {
            @Override
            public void onClick(View v) {
